...
def preprocess(args):
    if args.smi2token:
        if args.dataset_name == 'uspto_50k':
            raw_process = uspto50k()
        elif args.dataset_name == 'uspto_MIT':
            raw_process = usptoMIT()
        elif args.dataset_name == 'uspto_full':
            raw_process = usptofull()
        raw_process.process()
